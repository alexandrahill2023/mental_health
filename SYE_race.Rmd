...
#white 
#read
w_df <- readtext("white", cache=FALSE)
#remove .txt
...
#black  
#read
b_df <- readtext("black", cache=FALSE)
#remove .txt
...
#remove unneeded
rm(w_df, w_lem_count, b_df, b_lem_count, w_nest, b_nest)

#all novels together
all_novels <- bind_rows(w, b)
novel_list <- list(w, b)
novels_with_stop_list <- list(w_unnest, b_unnest)
#wordcount
