...
#male 
#read
wm <- readtext("white_male_char", cache=FALSE)
bm <- readtext("black_male_char", cache=FALSE)
...
#female 
wf <- readtext("white_fem_char", cache=FALSE)
bf <- readtext("black_fem_char", cache=FALSE)
fem <- bind_rows(wf, bf)
#remove .txt
